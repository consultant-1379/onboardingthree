 ...
 *******************************************************************************
 *----------------------------------------------------------------------------*/
package com.ericsson.ci.test.test.jee.ejb;
...
import com.ericsson.ci.test.api.Service;
import com.ericsson.ci.test.ejb.ServiceBean;
import com.ericsson.ci.test.ejb.ServiceLocal;
import com.ericsson.ci.test.impl.DateResolverBean;
import com.ericsson.ci.test.test.jee.Artifact;
